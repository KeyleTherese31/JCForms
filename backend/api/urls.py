...
from .views import AdminRegisterView, AdminLoginView, AdminListView, AdminDeactivateView, JobseekerCVView, JobseekerCVDetailView, mobile_login,BulkQuestionCreateView, SubmitTestView, JobseekerScoresView
